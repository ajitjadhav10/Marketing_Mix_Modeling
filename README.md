...
<br>**Dataset used:** https://github.com/ajitjadhav10/Mix_Marketing_Modeling/blob/d9759c6d8cc35d8dc112cc462eff02f63b38b7df/data.csv
...
- I've used the Custom Scaler provided by Lightweight MMM for scaling the dataset.

- Data in each column is scaled so that each one of them contributes equally to the model, this ensures that one feature does not have a dominating influence on the model because of its scale. For eg. if 10x money is spent on social media in comparison to sms marketing, then it'll make the model think that social media is more important than sms marketing without even comparing its effectiveness.
